...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<CelestialBronzeWorkBenchBlockEntity>> CELESTIAL_BRONZE_WORK_BENCH_BLOCK =
            BLOCK_ENTITIES.register("celestial_bronze_workbench", () ->
                    BlockEntityType.Builder.of(CelestialBronzeWorkBenchBlockEntity::new,
